...
import { loadAll, crearCliente, actualizarCliente, eliminarCliente } from '../services/crm.js?v=20260904-0325';
import { TIPOS_CLIENTE, estaAbierta, montoRef, normalizarTexto } from '../services/pipeline.js?v=20260904-0325';
import { money0, dateShort } from '../util/format.js?v=20260904-0325';
import { field, select, input, textarea, etapaTag } from './_ui.js?v=20260904-0325';
        ...
        try {
          if (c) {
            ...
            if (d.nombre !== c.nombre) {
              const { actualizarOportunidad } = await import('../services/crm.js?v=20260904-0325');
